...
CREATE TABLE IF NOT EXISTS `bzudsbddxmqodnzmzk08`.`USUARIOS` (
  ...
  `logradouro_usuario` VARCHAR(45) NOT NULL,
  `bairro_usuario` VARCHAR(45) NOT NULL,
  `uf_usuario` CHAR(30) NOT NULL,
  `cep_usuario` CHAR(30) NOT NULL,
